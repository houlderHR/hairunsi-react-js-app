...
const ResetPassword = () => {
  ...
  const { isUrlValid, isValidationLoading,isUrlError } = useCheckPasswordValidationLink();
  ...
  return (
    ...
    >
      ...
      {isUrlError && <p className="text-xs lg:text-sm text-gray-1 font-medium leading-4">
