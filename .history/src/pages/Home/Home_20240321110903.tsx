  ...
  return (
    <div  className="h-screen w-screen">
      <div className="relative w-full h-full bg-primary flex justify-center items-center justify-self-center">
        <div className="absolute w-1/4 lg:w-1/3 text-center z-50 flex flex-col justify-center">
          ...
          <div className="mt-20 text-white">
            ...
            <h3 className="mt-1 description text-center px-2 lg:px-36">Une plateforme de gestion et d'organisation en interne de vos rêves.</h3>
          </div>
          <Link to={'login'}>
