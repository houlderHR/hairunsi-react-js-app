  ...
  return (
    <div  className='flex justify-center items-center h-full '>
      <div className='relative w-full h-full bg-primary'>
        {/* <div className="absolute inset-0 bg-no-repeat bg-center bg-cover" style={{backgroundImage: `url(${bg})`}}></div> */}
        <img className="absolute inset-0 bg-no-repeat bg-center bg-primary bg-cover" src={bg} alt="F4" />
        <div className='text-center flex-col justify-center justify-items-center justify-self-center w-full h-full'>
          <div className="flex justify-center items-center">
            <img src="src/assets/logo.png" className='' alt="F4" />
          </div>
