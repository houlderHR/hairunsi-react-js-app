  ...
  return (
    <div  className="h-screen w-screen">
      <div className="relative w-full h-full bg-primary flex justify-center items-center justify-self-center">
        ...
        <div className="absolute bg-contain z-20 hidden lg:block inset-0 h-full w-full bg-no-repeat bg-contain object-fit" style={{backgroundImage: `url(${bgHome})`}}>
        </div>
        <div className="absolute bg-contain z-20 lg:hidden inset-0 h-full w-full bg-no-repeat bg-contain object-fit" style={{backgroundImage: `url(${bgMobile})`}}>
        </div>
      </div>
    </div>
  );
