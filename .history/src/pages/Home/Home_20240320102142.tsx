  ...
  return (
    <div  className='container-tmp h-screen w-screen'>
      <div className='relative w-full h-full bg-primary flex justify-center items-center justify-self-center '>
        ...
        <div className='absolute h-full w-screen object-fill'>
          <img className="absolute h-full w-screen z-20 inset-0 bg-no-repeat bg-center bg-primary " src={bgHome} alt="F4" />
        </div>
      </div>
    </div>
  );
