...
const Home = () => {
  return (
    <div  className='container-tmp h-full w-full'>
      <div className='relative w-full h-full bg-primary'>
        {/* <div className="absolute inset-0 bg-no-repeat bg-center bg-cover" style={{backgroundImage: `url(${bgHome})`}}></div> */}
        <div className='text-center z-50 flex-col justify-center justify-items-center justify-self-center w-full h-full'>
        ...
        <img className="absolute z-20 inset-0 bg-no-repeat bg-center bg-primary bg-cover" src={bgHome} alt="F4" />
      </div>
    </div>
  );
}
