...
import UnauthButton from '../../shared/unauthentified/buttons/Button';
      ...
      <div className="relative w-full h-full bg-primary flex justify-center items-center justify-self-center">
        <div className="absolute md:w-1/3 text-center z-50 flex flex-col justify-center">
          ...
          <div className="mt-20 text-white">
            <h2 className="text-2xl xl:text-4xl font-bold">Bienvenue sur HaiRun SI!</h2>
            <h3 className="mt-1 tet-sm xl:text-base text-center px-2 xl:px-36">Une plateforme de gestion et d'organisation en interne de vos rêves.</h3>
          </div>
          <Link to={LK_home}>
