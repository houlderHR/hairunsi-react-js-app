  ...
  return (
    <div  className="h-screen w-screen">
      <div className="relative w-full h-full bg-primary flex justify-center items-center justify-self-center">
        ...
        <div className="absolute bg-cover z-20 hidden xl:block inset-0 h-full w-full bg-no-repeat" style={{backgroundImage: `url(${bgHome})`}}>
        </div>
        <div className="absolute bg-cover z-20 xl:hidden inset-0 h-full w-full bg-no-repeat" style={{backgroundImage: `url(${bgMobile})`}}>
        </div>
      </div>
    </div>
  );
