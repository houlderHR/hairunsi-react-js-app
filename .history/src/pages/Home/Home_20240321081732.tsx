  ...
  return (
    <div  className="h-screen w-screen">
      <div className="relative w-full h-full bg-primary flex justify-center items-center justify-self-center">
        ...
        <div className="absolute bg-contain z-20 hidden xl:block inset-0 h-full w-full bg-no-repeat bg-contain" style={{backgroundImage: `url(${bgHome})`}}>
        ...
        <div className="absolute bg-contain z-20 xl:hidden inset-0 h-full w-full bg-no-repeat bg-cover" style={{backgroundImage: `url(${bgMobile})`}}>
          {/* <img className="object-fit hidden xl:block xs:h-screen bg-primary" src={bgHome} alt="" />
          <img className="object-fit xl:hidden  xs:h-screen" src={bgMobile} alt="" /> */}
        </div>
      </div>
