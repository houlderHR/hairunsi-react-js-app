  ...
  return (
    <div  className='container-tmp h-screen w-screen'>
      <div className='relative w-full h-full bg-primary flex justify-center items-center justify-self-center '>
        ...
        <div className='absolute lg:w-1/3 text-center z-50 flex-col justify-center justify-items-center justify-self-center'>
        ...
        <div className='absolute z-20 inset-0 h-full w-full bg-primary'>
