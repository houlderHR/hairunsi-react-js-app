...
const Home = () => {
  return (
    <div  className="h-screen w-screen">
      <div className="relative w-full h-full flex justify-center items-center justify-self-center">
        ...
        <div className="fixed z-20 inset-0 h-full w-full ">
          <img className="object-fit hidden xs:h-screen bg-primary" src={bgHome} alt="" />
          {/* <img className="object-fit xs:h-screen" src={bgMobile} alt="" /> */}
        </div>
      </div>
    </div>
  );
