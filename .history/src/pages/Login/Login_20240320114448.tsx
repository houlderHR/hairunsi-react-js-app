  ...
  return (
    <div className='flex'>
      <div className='relative h-screen left_grid bg-red-300'>
        <div className="absolute z-20 text-white flex flex-col justify-center justify-items-center justify-self-center h-full px-20">
          <h2 className='welcome_login'>Bienvenue sur HaiRun SI !</h2>
