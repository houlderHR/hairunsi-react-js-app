...
import { faEyeDropper, faPenNib } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className='flex h-screen'>
      ...
      <div className="w-full h-full flex justify-center">
        <div className="w-1/3 text-center flex flex-col justify-center flex-items-center">
          ...
          <hr className="mx-20"/>
          <span className="text-black1 mt-8" style={{fontSize:'14px'}}>Mot de passe oublié? <Link to={'/'}><b>Cliquez ici.</b></Link></span>
        </div>
      </div>
    </div>
  )
