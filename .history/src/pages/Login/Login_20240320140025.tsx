      ...
      <div className='w-full h-full flex justify-center'>
        <div className='w-1/3 text-center flex flex-col justify-center flex-items-center'>
          ...
          <div className='mt-10 mb-8'>
            ...
            <input type="text" name="" className="border mb-1 px-3 py-3 w-full rounded-md" placeholder="Mot de passe" id="" />
          </div>
          <div className="flex justify-left text-grey2">
            <input type="checkbox" name="" id="remember" />&nbsp;&nbsp;&nbsp; <label htmlFor="remember">Se souvenir de moi</label>
          </div>
          <button className="mt-2 px-2 py-2 border bg-grey1 text-white">Se connecter</button>
          <hr />
