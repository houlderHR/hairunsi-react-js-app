    ...
    <div className='flex h-screen'>
      ...
      <div className='w-full h-full flex justify-center'>
        <div className='w-1/3 text-center flex flex-col justify-center flex-items-center'>
          ...
          <div>
            <input type="text" className="border mb-2 px-3 py-3 w-3/4 rounded-sm" name="" placeholder="Adresse e-mail" id="" /><br />
            <input type="text" name="" className="border px-2 py-1" placeholder="Mot de passe" id="" />
          </div>
