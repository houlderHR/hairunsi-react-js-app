    ...
    <div className='flex h-screen'>
      ...
      <div className='w-full h-full flex justify-center'>
        <div className='w-1/3 text-center flex flex-col justify-center flex-items-center'>
          ...
          <div>
            <input type="text" className="border mb-3 px-3 py-3 w-3/4 rounded-md" name="" placeholder="Adresse e-mail" id="" /><br />
            <input type="text" name="" className="border mb-2 px-3 py-3 w-3/4 rounded-md" placeholder="Mot de passe" id="" />
          </div>
         
          <button className="mt-2 px-2 py-2 border">Se connecter</button>
          <hr />
